        ...
        function Funcao1($quiz, $nome)
        {
            ...
            $q ='<tr>
                <td colspan="2">
                    ...
                    <input type="text" name="nome" value="'.$nome.'" disabled><br/>
        ...
        <table>
            ...
            <?php
                ...
                elseif (isset($_POST["enviar"])) {
                    ...
                    if (isset($_POST["nome"])) {
                        $nome = $_POST["nome"];
                        $pagina = Funcao1($quiz, $nome);
                        echo $pagina;
                                if (isset($_POST["responder"])) {
                                    $botao = $_POST["responder"];
                                    if (isset($_POST["alternativa"]) && $_POST["alternativa"] == $quiz[0][5]) {
                                        $pagina = Funcao1($quiz, $nome);
                                        echo $pagina;
                                        echo '<tr class="mensagem">
                                            ...
                                            if (isset($_POST["continuar"])) {
                                                ...
                                                $pagina = Funcao2($quiz, $nome);
                                                echo $pagina;
                                            }
                                    }
                                    elseif (isset($_POST["alternativa"]) && $_POST["alternativa"] != $quiz[$i - 2][5]) {
                                        $pagina = Funcao1($quiz, $nome);
                                        echo $pagina;
                                        echo '<tr class="mensagem">
