...
<?php
    ...
    <div class="container body-content">
        <footer>
            ...
            <div class="div2">
                <p>Desenvolvedores:</p>
                <p>Ana Karolina - <a href="ana.querino@escolar.ifrn.edu.br">ana.querino@escolar.ifrn.edu.br</a></p>
                <p>Clarisse Cândido - <a href="candido.c@escolar.ifrn.edu.br">candido.c@escolar.ifrn.edu.br</a></p>
                <p>Laura Mayza - <a href="candido.c@escolar.ifrn.edu.br">candido.c@escolar.ifrn.edu.br</a></p>
            </div>
        </footer>
    </div>
