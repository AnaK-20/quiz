...
<body>
    <?php
    $perguntas = array('Quem é a autora que recebeu ao nascer o nome Chaya Pinkhasovna( posteriormente o mudou) teve que fugir para o Brasil devido ao 
...
$opcoes = array(
    array('Cecília Meireles(1901-1964) - autora da obra “Romanceiro da Inconfidência”.',
    ...
    array('Adélia Prado', 'Conceição Evaristo', 'Maria Firmina dos Reis', 'Carolina Maria de Jesus'),
    array('José de Alencar', ' Mário Quintana', 'Jorge Amado', 'Carlos Drummond de Andrade'),
    array('Mário Quintana', 'Jorge Amado', 'Machado de Assis', 'Carlos Drummond de Andrade'),
    array('Cecília Meireles', 'Cora Coralina', 'Rachel de Queiroz', 'Hilda Hilst'),
